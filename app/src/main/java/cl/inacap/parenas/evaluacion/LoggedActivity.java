    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        productos.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent productointent = new Intent(LoggedActivity.this, Pedidos.class);
                LoggedActivity.this.startActivity(productointent);
            }
        });
    ...
    public void Añadir(){
        ...
        agregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(insertData){
                    Toast.makeText(LoggedActivity.this, "Cliente Agregado", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(LoggedActivity.this, "Ocurrio un error", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
        ...
        actualizar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if(temp > 0){
                    ...
                    if(actualizar == true){
                        Toast.makeText(LoggedActivity.this, "Cliente actualizado correctamente", Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(LoggedActivity.this, "Ocurrio un error", Toast.LENGTH_LONG).show();
                    }
                }else{
                    Toast.makeText(LoggedActivity.this, "Ingrese la ID del cliente que desee actualizar", Toast.LENGTH_LONG).show();
                }
        ...
        borrar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (temp > 0){
                    ...
                    if(deleteRow > 0){
                        Toast.makeText(LoggedActivity.this, "Cliente eliminado correctamente", Toast.LENGTH_LONG).show();
                    }else{
                        Toast.makeText(LoggedActivity.this, "Ocurrio un error", Toast.LENGTH_LONG).show();
                    }
                }else{
                    Toast.makeText(LoggedActivity.this, "Ingrese la ID del cliente que desee borrar", Toast.LENGTH_LONG).show();
                }
            }
        });
    }
